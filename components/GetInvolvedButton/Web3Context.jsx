  ...
  const connectToMetaMask = async () => {
    ...
    if (window.ethereum) {
      try {
        ...
        const message = `${domain} wants you to sign in with your Ethereum account:\n${account}\n\nWelcome to the KnowledgeFi movement. By connecting to the site, you are allowing us to log your wallet address and the date / time of login. More details will be revealed in due course.\n\nURI: https://${domain}\nVersion: 1\nChain ID: 1\nNonce: 32891757\nIssued At: 2021-09-30T16:25:24.000Z`;
