  ...
  return (
    <div className={cn("section", styles.section)}>
      ...
      <div className={cn("container-wide", styles.container)}>
        ...
        KIP Protocol is the decentralised base layer that AI models, 
        apps & data owners build on, to safely transact & monetise in Web3.
        </h2>
          ...
          {development.map((item, index) => (
            ...
            >
              <div className={styles.preview}>
                <Image src={item.image} layout="fill" alt="Figure" />
              </div>
